...
public class SimpleExample {
  ...
  public void run() throws Exception {
    ...
    JobDetail job2 = newJob(OneJob.class).withIdentity("job1", "group2").build();
    ...
    log.info(job1.getKey() + " will run at: " + runTime);
    log.info(job2.getKey() + " will run at: " + runTime);
    log.info(trigger1.getJobKey()+"--------------->>>>>>>>>>>>>");
